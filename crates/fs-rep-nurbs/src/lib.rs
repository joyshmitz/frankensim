...
pub use basis::{
    AdmittedKnotVector, BasisRun, KnotAdmissionRun, KnotCloneRun, KnotConstructionRun,
    KnotDomainRun, KnotSpanRun, KnotVector, Scalar,
};
...
pub use rat::Rat;
pub use surface::{
    AdmittedNurbsSurface, NurbsSurface, SurfaceAdmissionRun, SurfaceCloneRun,
    SurfaceConstructionRun, SurfaceEvaluationRun, SurfaceHomogeneousEvaluationRun,
...
pub use trim::{
    ...
    TrimLoopAdmissionRun, TrimLoopCloneRun, TrimLoopConstructionRun, TrimLoopReversalRun,
    TrimmedPatch, TrimmedPatchAdmissionRun, TrimmedPatchCloneRun,
};
