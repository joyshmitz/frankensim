//! fs-obs — Structured observability: the one event schema for kernels, tests, and the ledger.
//!
//! Layer: UTIL. See CONTRACT.md for invariants, error model, determinism
