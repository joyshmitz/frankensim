...
fn i14_claims() -> Vec<ClaimSpec> {
    vec![
        ...
        ClaimSpec {
            ...
            statement: "Falsifier lane: exhaust a future cardinality-proved finite rational microgrammar and search a separately seeded adversarial supergrammar for full-wave stability failures, BEM/FMM dense-envelope escapes, fidelity-bound violations, unsafe robust mitigations, assurance laundering, and countermodels to the fidelity-descent, passive-causal composition, hypercohomology-obstruction, cover-refinement-naturality and KYP-sheaf-bridge theorem revisions. Every candidate is independently classified, every nonvacuity/coverage floor is checked, and every genuine in-domain countermodel is minimized and retained",
            hypotheses: &[
...
SEED DOMAINS: development 0..=4095; Core PublicReplay holdout 65536..=69631; Max PublicReplay holdout 131072..=135167; falsifier 196608..=212991. These ranges are disjoint inclusive intervals under the Five Explicits derivation and confer replay only."#,
        ...
        authored_fixture(
            ...
            r#"GENERATOR: cross-domain adversaries combining topology/reference changes, MTL/PEEC/full-wave validity escape, resonance, PML late-time instability, BEM/FMM envelope error, source/probe aliasing, victim event discontinuity, correlated uncertainty, unsafe mitigation, assurance laundering, theorem-premise boundary cases, and reason-coded negative controls. Every candidate binds its grammar revision, rank, validity decision, model fingerprints, and independent adjudication state. SEEDS: i14/i14-maximal-adversaries/falsifier, falsifier range."#,
            Partition::Development,
        ),
    ]
}
